	...
	<div id="app">
		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Características do Problema">
					<span class="mr-4"><input type="checkbox" 
								value="1" v-model="caracteristicas"> Reproduzível</span>
					<span><input type="checkbox" 
								value="intermitente" v-model="caracteristicas"> Intermitente</span>
				</Rotulo>
				<Rotulo nome="Qual produto?">
					<span class="mr-4"><input type="radio" value="1" v-model="produto"> Web</span>
					<span class="mr-4"><input type="radio" value="Movél" v-model="produto" > Mobile</span>
			...
			<div class="painel" v-else>
				...
				<Rotulo nome="Mensagem">
					<span style="white-space: pre; text-align: justify;"  >{{mensagem}}</span>
				</Rotulo>
